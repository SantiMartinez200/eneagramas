...
use App\Http\Requests\EneagramaUsuarioFraseRequest;
use App\Models\EneagramaUsuarioFrase;
use Illuminate\Http\Request;

class EneagramaUsuarioFraseController extends Controller
{
    ...
    public function esDeEsteUsuario($eneagramaUsuarioId)
    {
        ...
        $existe = EneagramaUsuarioFrase::whereHas('cuestionario', function ($query) use ($userId, $eneagramaUsuarioId) {
     ...
     */
    public function store(EneagramaUsuarioFraseRequest $request)
    {
        ...
        $frase = EneagramaUsuarioFrase::create([
            'frase' => $validated['nueva_frase'],
     ...
     * Store a newly created resource in storage.
     */
    public function show(EneagramaUsuarioFrase $eneagrama)
    {
        //
    }
}
